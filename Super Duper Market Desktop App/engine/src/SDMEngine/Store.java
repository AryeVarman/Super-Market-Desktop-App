...
public class Store implements Coordinatable, Serializable {
    ...
    public Store(int serialNumber, String name, Coordinate coordinate, double PPK) {
    ...
    public Store(int serialNumber, String name, Map< Integer,StoreItem> itemsList ,Coordinate coordinate, double PPK) {
        this.serialNumber = serialNumber;
        this.name = name.toLowerCase();
        this.coordinate = coordinate;
        this.coordinate.setElement(this);
    ...
    public Store(int serialNumber, String name, Map< Integer,StoreItem> itemsList , Coordinate coordinate, Map<String, Sale> saleList, double PPK) {
        this.serialNumber = serialNumber;
        this.name = name.toLowerCase();
        this.coordinate = coordinate;
        this.coordinate.setElement(this);
